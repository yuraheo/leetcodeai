...
llmService.registerTemplate({
  id: "leetcode-answer",
  systemPrompt:
    'You are a virtual evaluator coding questions. Given a question and some code written by a student, your job is to give just the correct code based on the code that the student wrote without any explanation.',
  userPrompt: `
  PROBLEM:
  {{problem}}
